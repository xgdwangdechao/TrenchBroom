...
namespace TrenchBroom {
    ...
    namespace Model {
        ...
        public: // move face along normal
             ...
             *
             * The face is only translated if the resulting brush does not exceed world bounds and if it has the same
             * number of faces as this brush. If the resulting brush becomes invalid, an error is returned.
             *
             ...
             */
            kdl::result<Brush, GeometryException> moveBoundary(const vm::bbox3& worldBounds, size_t faceIndex, const vm::vec3& delta, bool lockTexture) const;
        ...
        public:
             ...
             */
            kdl::result<Brush, GeometryException> intersect(const vm::bbox3& worldBounds, const Brush& brush) const;
             ...
             */
            kdl::result<Brush, GeometryException> transform(const vm::bbox3& worldBounds, const vm::mat4x4& transformation, bool lockTextures) const;
        public:
