...
namespace TrenchBroom {
    ...
    namespace View {
        ...
        private:
             ...
             */
            std::chrono::time_point<Clock> m_lastModificationTime;
        ...
        public:
            explicit Autosaver(std::weak_ptr<MapDocument> document, std::chrono::milliseconds saveInterval = std::chrono::milliseconds(10 * 60 * 1000), std::chrono::milliseconds idleInterval = std::chrono::seconds(3 * 1000), size_t maxBackups = 50);
            ~Autosaver();
