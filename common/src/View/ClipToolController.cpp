...
namespace TrenchBroom {
    namespace View {
        ...
        std::vector<vm::vec3> ClipToolController3D::selectHelpVectors(Model::BrushNode* brushNode, const Model::BrushFace* face, const vm::vec3& hitPoint) {
        ...
        std::vector<const Model::BrushFace*> ClipToolController3D::selectIncidentFaces(Model::BrushNode* brushNode, const Model::BrushFace* face, const vm::vec3& hitPoint) {
