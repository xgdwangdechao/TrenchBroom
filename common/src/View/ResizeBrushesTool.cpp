...
namespace TrenchBroom {
    namespace View {
        ...
        public:
            ...
            bool operator()(const Model::BrushFaceHandle& faceHandle) const {
        ...
        bool ResizeBrushesTool::resize(const vm::ray3& pickRay, const Renderer::Camera& /* camera */) {
            ...
            const auto absoluteFaceDelta = grid.moveDelta(dragFaceHandle.node()->brush(), *dragFace, faceNormal * dragDist);
