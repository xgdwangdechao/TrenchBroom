...
namespace TrenchBroom {
    namespace Model {
        ...
        TEST_CASE("BrushTest.constructBrushWithFaces", "[BrushTest]") {
            ...
            const Brush brush = kdl::get_success(Brush::create(worldBounds, {
                // left
        ...
        TEST_CASE("BrushTest.clip", "[BrushTest]") {
            ...
            // build a cube with length 16 at the origin
            Brush brush = kdl::get_success(Brush::create(worldBounds, { left, right, front, back, top, bottom }));
        ...
        TEST_CASE("BrushTest.moveBoundary", "[BrushTest]") {
            const vm::bbox3 worldBounds(4096.0);
            Brush brush = kdl::get_success(Brush::create(worldBounds, {
        ...
        TEST_CASE("BrushTest.resizePastWorldBounds", "[BrushTest]") {
            ...
            Brush brush1 = kdl::get_success(builder.createBrush(std::vector<vm::vec3>{vm::vec3(64, -64, 16), vm::vec3(64, 64, 16), vm::vec3(64, -64, -16), vm::vec3(64, 64, -16), vm::vec3(48, 64, 16), vm::vec3(48, 64, -16)}, "texture"));
        ...
        TEST_CASE("BrushTest.expand", "[BrushTest]") {
            ...
            Brush brush1 = kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(-64, -64, -64), vm::vec3(64, 64, 64)), "texture"));
        ...
        TEST_CASE("BrushTest.moveVertex", "[BrushTest]") {
            ...
            Brush brush = kdl::get_success(builder.createCube(64.0, "left", "right", "front", "back", "top", "bottom"));
        ...
        TEST_CASE("BrushTest.moveTetrahedronVertexToOpposideSide", "[BrushTest]") {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = kdl::get_success(builder.createBrush(points, "some_texture"));
        ...
        TEST_CASE("BrushTest.moveVertexInwardWithoutMerges", "[BrushTest]") {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = kdl::get_success(builder.createBrush(oldPositions, "texture"));
        ...
        TEST_CASE("BrushTest.moveVerticesPastWorldBounds", "[BrushTest]") {
            ...
            Model::Brush brush = kdl::get_success(builder.createCube(128.0, "texture"));
        ...
        TEST_CASE("BrushTest.movePointRemainingPolygon", "[BrushTest]") {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = kdl::get_success(builder.createBrush(vertexPositions, Model::BrushFaceAttributes::NoTextureName));
        ...
        TEST_CASE("BrushTest.removeSingleVertex", "[BrushTest]") {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = kdl::get_success(builder.createCube(64.0, "asdf"));
            ...
            for (size_t i = 0; i < 6; ++i) {
                for (size_t j = i + 1; j < 7; ++j) {
                    for (size_t k = j + 1; k < 8; ++k) {
                        ...
                        Brush brush = kdl::get_success(builder.createBrush(vertices, "asdf"));
        ...
        TEST_CASE("BrushTest.moveEdgeRemainingPolyhedron", "[BrushTest]") {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = kdl::get_success(builder.createCube(128, Model::BrushFaceAttributes::NoTextureName));
        ...
        TEST_CASE("BrushNodeTest.cannotMoveFace", "[BrushNodeTest]") {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = kdl::get_success(builder.createCuboid(vm::vec3(128.0, 128.0, 32.0), Model::BrushFaceAttributes::NoTextureName));
        ...
        TEST_CASE("BrushTest.movePolygonRemainingPolygon", "[BrushTest]") {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = kdl::get_success(builder.createCube(128.0, Model::BrushFaceAttributes::NoTextureName));
        ...
        TEST_CASE("moveFaceWithUVLock", "[UVLockTest]") {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = kdl::get_success(builder.createCube(64.0, ""));
...
( -5764.7302805002028 494 1030 ) ( -5734.7302804990195 638 1030 ) ( -5734.7302804990386 722 1030 ) so_b4b -33.27 6 -0 1 1
        ...
        TEST_CASE("BrushTest.moveFaceFailure_1499", "[BrushTest]") {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = kdl::get_success(builder.createBrush(points, "asdf"));
        ...
        TEST_CASE("BrushTest.subtractCuboidFromCuboid", "[BrushTest]") {
            ...
            BrushBuilder builder(&world, worldBounds);
            const Brush minuend = kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(-32.0, -16.0, -32.0), vm::vec3(32.0, 16.0, 32.0)), minuendTexture));
            const Brush subtrahend = kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(-16.0, -32.0, -64.0), vm::vec3(16.0, 32.0, 0.0)), subtrahendTexture));
        ...
        TEST_CASE("BrushTest.subtractDisjoint", "[BrushTest]") {
            ...
            BrushBuilder builder(&world, worldBounds);
            const Brush brush1 = kdl::get_success(builder.createCuboid(brush1Bounds, "texture"));
            const Brush brush2 = kdl::get_success(builder.createCuboid(brush2Bounds, "texture"));
