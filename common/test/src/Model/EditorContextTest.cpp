    ...
    namespace Model {
        ...
        protected:
            ...
            std::tuple<EntityNode*, BrushNode*> createTopLevelBrushEntity() {
                ...
                auto* brush = world->createBrush(kdl::get_success(builder.createCube(32.0, "sometex")));
                auto* entity = world->createEntity();
            ...
            std::tuple<GroupNode*, GroupNode*, BrushNode*> createdNestedGroupedBrush() {
                BrushBuilder builder(world, worldBounds);
                auto* innerBrush = world->createBrush(kdl::get_success(builder.createCube(32.0, "sometex")));
