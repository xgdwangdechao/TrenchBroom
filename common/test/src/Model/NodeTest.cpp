...
namespace TrenchBroom {
    namespace Model {
        ...
        TEST_CASE("CollectTouchingNodesVisitor", "[NodeVisitorTest]") {
            ...
            BrushNode* brush1 = map.createBrush(kdl::get_success(builder.createCube(64.0, "none")));
            BrushNode* brush2 = map.createBrush(kdl::get_success(builder.createCube(64.0, "none")));
            BrushNode* brush3 = map.createBrush(kdl::get_success(builder.createCube(64.0, "none")));
