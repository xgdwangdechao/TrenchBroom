...
namespace TrenchBroom {
    namespace View {
        ...
        Model::BrushNode* MapDocumentTest::createBrushNode(const std::string& textureName, const std::function<void(Model::Brush&)>& brushFunc) {
            ...
            Model::Brush brush = kdl::get_success(builder.createCube(32.0, textureName));
            brushFunc(brush);
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.flip") {
            ...
            Model::BrushNode* brush1 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0.0, 0.0, 0.0), vm::vec3(30.0, 31.0, 31.0)), "texture")));
            Model::BrushNode* brush2 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(30.0, 0.0, 0.0), vm::vec3(31.0, 31.0, 31.0)), "texture")));
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.shearCube") {
            ...
            Model::BrushBuilder builder(document->world(), document->worldBounds());
            Model::BrushNode* brushNode = document->world()->createBrush(kdl::get_success(builder.createCuboid(initialBBox, "texture")));
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.csgConvexMergeBrushes") {
            ...
            auto* brush1 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(32, 64, 64)), "texture")));
            auto* brush2 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(32, 0, 0), vm::vec3(64, 64, 64)), "texture")));
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.csgConvexMergeFaces") {
            ...
            auto* brushNode1 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(32, 64, 64)), "texture")));
            auto* brushNode2 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(32, 0, 0), vm::vec3(64, 64, 64)), "texture")));
        ...
        TEST_CASE_METHOD(ValveMapDocumentTest, "ValveMapDocumentTest.csgConvexMergeTexturing") {
            ...
            Model::Brush brush1 = kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(32, 64, 64)), "texture"));
            brush1.face(*brush1.findFace(vm::vec3::pos_z())).restoreTexCoordSystemSnapshot(*texAlignmentSnapshot);

            Model::Brush brush2 = kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(32, 0, 0), vm::vec3(64, 64, 64)), "texture"));
        ...
        TEST_CASE_METHOD(ValveMapDocumentTest, "ValveMapDocumentTest.csgSubtractTexturing") {
            ...
            Model::Brush brush1 = kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(64, 64, 64)), "texture"));
            Model::Brush brush2 = kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(64, 64, 32)), "texture"));
            brush2.face(*brush2.findFace(vm::vec3::pos_z())).restoreTexCoordSystemSnapshot(*texAlignmentSnapshot);
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.csgSubtractMultipleBrushes") {
            ...
            Model::BrushNode* minuend = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(64, 64, 64)), "texture")));
            Model::BrushNode* subtrahend1 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(32, 32, 64)), "texture")));
            Model::BrushNode* subtrahend2 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(32, 32, 0), vm::vec3(64, 64, 64)), "texture")));
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.csgSubtractAndUndoRestoresSelection") {
            ...
            Model::BrushNode* subtrahend1 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(64, 64, 64)), "texture")));
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.ungroupLeavesBrushEntitySelected") {
            ...
            Model::BrushNode* brush1 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(64, 64, 64)), "texture")));
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.pickSingleBrush") {
            ...
            auto* brushNode1 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(64, 64, 64)), "texture")));
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.pickSimpleGroup") {
            ...
            auto* brushNode2 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(64, 64, 64)).translate(vm::vec3(0, 0, 128)), "texture")));
            document->addNode(brushNode2, document->parentForNodes());
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.pickNestedGroup") {
            ...
            document->deselectAll();
            auto* brushNode3 = document->world()->createBrush(kdl::get_success(builder.createCuboid(vm::bbox3(vm::vec3(0, 0, 0), vm::vec3(64, 64, 64)).translate(vm::vec3(0, 0, 256)), "texture")));
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.selectTouching") {
            ...
            auto *brush1 = document->world()->createBrush(kdl::get_success(builder.createCuboid(box, "texture")));
            document->addNode(brush1, document->parentForNodes());

            auto *brush2 = document->world()->createBrush(kdl::get_success(builder.createCuboid(box.translate(vm::vec3(1, 1, 1)), "texture")));
            document->addNode(brush2, document->parentForNodes());
        ...
        TEST_CASE_METHOD(MapDocumentTest, "MapDocumentTest.selectInverse") {
            ...
            auto *brush3 = document->world()->createBrush(kdl::get_success(builder.createCuboid(box.translate(vm::vec3(2, 2, 2)), "texture")));
